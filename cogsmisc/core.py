...
class Core:
    ...
    async def invite(self):
        """Prints a link to invite Ragnarok to your server."""
        await self.bot.say("Ragnarok is not available for public use, but Avrae, a similar bot, is.\nYou can invite Avrae to your server here:\nhttps://discordapp.com/oauth2/authorize?&client_id=261302296103747584&scope=bot&permissions=36727808")
        
    @commands.command(aliases=['stats', 'info'])
    async def about(self):
        """Information about the bot."""
        embed = discord.Embed(description='Ragnarok, a bot to streamline D&D 5e online.')
        embed.title = "Invite Avrae to your server! (Ragnarok is not available for public use, but Avrae, a similar bot, is.)"
